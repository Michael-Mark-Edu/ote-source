...
public class GetTests
{
    ...
    public async Task SimpleTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/books/{{bookISBN}} SimpleTest | response.Body = {response.Body}");
    ...
    public async Task NegativeIdTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/books/{{bookISBN}} NegativeIdTest | response.Body = {response.Body}");
