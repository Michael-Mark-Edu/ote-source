...
public class GetTests
{
    ...
    public async Task IllegalCookiesTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/users IllegalCookiesTest | response.Body = {response.Body}");
    ...
    public async Task NonAdminCookiesTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/users NonAdminCookiesTest | response.Body = {response.Body}");
    ...
    public async Task NoCookiesTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/users NoCookiesTest | response.Body = {response.Body}");
