...
public class PostTests
{
    ...
    public async Task MissingFieldTest()
    {
        ...
        context.Logger.LogDebug($"POST /api/listings MissingFieldTest | response.Body = {response.Body}");
    ...
    public async Task DuplicateTest()
    {
        ...
        context.Logger.LogDebug($"POST /api/listings DuplicateTest | response.Body 1 = {response.Body}");
        Assert.Equal(200, response.StatusCode);
    ...
    public async Task DuplicateFieldTest()
    {
        ...
        context.Logger.LogDebug($"POST /api/listings DuplicateFieldTest | response.Body = {response.Body}");
        Assert.Equal(400, response.StatusCode);
    }
}
