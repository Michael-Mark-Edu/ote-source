...
public class PatchTests
{
    ...
    public async Task UserSelfPatchTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} UserSelfPatchTest | response.Body = {response.Body}");
    ...
    public async Task SelfRouteTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} SelfRouteTest | response.Body = {response.Body}");
        Assert.Equal(200, response.StatusCode);
    ...
    public async Task AdminPatchTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} AdminPatchTest | response.Body = {response.Body}");
        Assert.Equal(200, response.StatusCode);
    ...
    public async Task IllegalCookiesTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} IllegalCookiesTest | response.Body = {response.Body}");
    ...
    public async Task WrongCookiesTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} WrongCookiesTest | response.Body = {response.Body}");
        Assert.Equal(403, response.StatusCode);
    }
    ...
    public async Task NoCookiesTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} NoCookiesTest | response.Body = {response.Body}");
    ...
    public async Task DuplicateFieldTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} DuplicateFieldTest | response.Body = {response.Body}");
    ...
    public async Task FakeFieldTest()
    {
        ...
        context.Logger.LogDebug($"PATCH /api/listings/{{listingId}} FakeFieldTest | response.Body = {response.Body}");
        Assert.Equal(400, response.StatusCode);
    }
}
