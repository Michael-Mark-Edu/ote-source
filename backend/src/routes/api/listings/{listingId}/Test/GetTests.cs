...
public class GetTests
{
    ...
    public async Task SimpleTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/listings/{{listingId}} SimpleTest | response.Body = {response.Body}");
    ...
    public async Task SelfRouteTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/listings/{{listingId}} SelfRouteTest | response.Body = {response.Body}");
        Assert.Equal(200, response.StatusCode);
    ...
    public async Task NegativeIdTest()
    {
        ...
        context.Logger.LogDebug($"GET /api/listings/{{listingId}} NegativeIdTest | response.Body = {response.Body}");
